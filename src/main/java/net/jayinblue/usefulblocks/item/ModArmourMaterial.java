...
public enum ModArmourMaterial implements ArmorMaterial {
    COPPER("copper", 12, new int[]{2, 3, 4, 2}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(ModItems.COPPER_PLATE);
    });
    ...
    private ModArmourMaterial(String name, int durabilityMultiplier, int[] protectionAmounts,
